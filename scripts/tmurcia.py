...
def fetchInfo() -> tuple[list[c.LineObject], list[c.StopObject]]:
    lines: list[c.LineObject] = []
    stops: list[c.StopObject] = []

    r = requests.post(API_URL, REQUEST_BODY, headers={"Content-Type": "text/xml"})
...
# Moved down here since it messes with syntax highlighting
REQUEST_BODY = """<?xml version='1.0' encoding='utf-8'?><soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema'><soap:Body><LinesDiscovery xmlns='http://tempuri.org/'><request><Request xmlns=''><RequestTimestamp xmlns='http://www.siri.org.uk/siri'>2025-11-05T12:44:21.1920000+01:00</RequestTimestamp><AccountId xmlns='http://www.siri.org.uk/siri'>wshuesca</AccountId><AccountKey xmlns='http://www.siri.org.uk/siri'>WS.huesca</AccountKey><LinesDetailLevel xmlns='http://www.siri.org.uk/siri'>normal</LinesDetailLevel></Request></request></LinesDiscovery></soap:Body></soap:Envelope>"""
